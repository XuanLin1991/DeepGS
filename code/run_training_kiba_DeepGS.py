...
if __name__ == "__main__":
    ...
    """处理smile"""
    with open('../dataset/' + DATASET + '/original/smile_n_gram.txt', 'r') as f:
...
#     interactions = list(interactions)
    ...
    """Set a model."""
    file_model = '../output/model/'+'kiba--radius2--ngram3--dim32--layer_gnn3--window11--layer_cnn3--layer_output3--lr2e-6--lr_decay0.9--decay_interval5--weight_decay1e-5--iteration200model_load_3'
    ...
    """Output files."""
    file_MSEs = '../output/result/' + setting + 'model_load_3.txt'
    file_T = '../output/predict/T--' + setting + 'model_load_3.txt'
    file_S = '../output/predict/S--' + setting + 'model_load_3.txt'
    file_model = '../output/model/' + setting + 'model_load_3'
