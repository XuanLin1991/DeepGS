...
#         self.W_interaction = nn.Linear(2*100+128, 1)
        self.W_out = nn.ModuleList([nn.Linear(200+100, 200+100)
                                    for _ in range(layer_output)])
        self.W_interaction = nn.Linear(200+100, 1)
...
#     model.load_state_dict(torch.load(file_model))
    ...
    """Output files."""
    file_MSEs = '../output/result/' + setting + 'DeepGS2.txt'
    file_T = '../output/predict/T--' + setting + 'DeepGS2.txt'
    file_S = '../output/predict/S--' + setting + 'DeepGS2.txt'
    file_model = '../output/model/' + setting + 'DeepGS2'
